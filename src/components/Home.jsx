...
const Home = ({ addTodo, todos, sendToTrash, togglePriority, deleteTodo, showAddTodo}) => {
    return (
        // 
        <Container >
            <Row className="justify-content-center" >
                ...
                {todos.length >0 ? <Todos sendToTrash={sendToTrash} onDelete={deleteTodo} onToggle={togglePriority} /> : "No todos to show"}
            </Row>
            <ScrollToTop />
        </Container>
    )
